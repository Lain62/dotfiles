...
(let ((rosevu-black-darker "#1B2021")
  ...
  (custom-theme-set-faces 
   ...
   `(mode-line ((t ( :background ,rosevu-pink ))))
   `(region ((t ( :background ,rosevu-gray-darker))))
   `(secondary-selection ((t (:background ,rosevu-purple ))))
   `(font-lock-builtin-face ((t (:background ,rosevu-pink))))
   `(font-lock-comment-face ((t (:foreground ,rosevu-red))))
   `(font-lock-function-name-face ((t ( :background ,rosevu-cream ))))
   `(font-lock-keyword-face ((t ( :background ,rosevu-pink ))))
   `(font-lock-string-face ((t ( :background ,rosevu-green ))))
   `(font-lock-type-face ((t ( :background ,rosevu-cream ))))
   `(font-lock-constant-face ((t ( :background ,rosevu-purple))))
   `(font-lock-variable-name-face ((t ( :background ,rosevu-purple ))))
   `(minibuffer-prompt ((t ( :background ,rosevu-pink))))
   `(font-lock-warning-face ((t ( :foreground ,rosevu-red))))
   `(dired-directory ((t ( :background ,rosevu-purple))))
   ))
