...
(let ((rosevu-black "#1B2021")
  ...
  (custom-theme-set-faces 'rosevu
                          ...
                          `(dired-directory ((t (:foreground ,rosevu-blue :weight bold))))

                          `(whitespace-space ((t ,(list :background rosevu-black
                                                        :foreground rosevu-black-lighter))))
                          `(whitespace-newline ((t ,(list :background rosevu-black
