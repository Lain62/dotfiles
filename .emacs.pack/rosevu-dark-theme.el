...
(let ((rosevu-black-darker "#1B2021")
  ...
  (custom-theme-set-faces 'rosevu-dark
                          `(default ((t (:foreground ,rosevu-gray :background ,rosevu-black))))
                          `(cursor ((t (:background ,rosevu-yellow ))))
                          `(fringe ((t (:background ,rosevu-black ))))
                          `(mode-line ((t (:foreground ,rosevu-black-darker :background ,rosevu-pink ))))
                          ...
                          `(font-lock-comment-face ((t (:foreground  ,rosevu-pink-darker ))))
                          ...
                          `(font-lock-type-face ((t (:foreground ,rosevu-red ))))
                          `(font-lock-constant-face ((t (:foreground ,rosevu-purple ))))
                          `(font-lock-variable-name-face ((t (:foreground ,rosevu-cyan ))))
